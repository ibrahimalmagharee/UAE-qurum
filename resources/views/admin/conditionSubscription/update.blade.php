...
@section('title',app('settings')->get('app_name_'.get_admin_locale()) . ' - '. __('labels.nav_menu.condition_subscription'))
        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">@lang('labels.nav_menu.condition_subscription') </h3>
                    <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                    @if(get_admin_locale() == 'ar')
                        <span class="kt-subheader__desc">{{$condition_subscription->title_ar}}</span>
                    @elseif(get_admin_locale() == 'en')
                        <span class="kt-subheader__desc">{{$condition_subscription->title_en}}</span>
                    @endif
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            @endif
                            <form id="form-create-static_page" action="{{route_url('admin.condition_subscription.update')}}" method="post" class="kt-form" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" id="id" name="id" value="{{$condition_subscription->id}}">
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="text" name="title_ar" id="title_ar" class="form-control" value="{{$condition_subscription->title_ar}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="text" name="title_en" id="title_en" class="form-control" value="{{$condition_subscription->title_en}}">
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                        <span class="form-text text-muted"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description1_ar" cols="38" rows="6">{!! $condition_subscription->description1_ar !!}</textarea>
{{--                                                        <div id="description1_ar">{!! $condition_subscription->description1_ar !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description1_en" cols="38" rows="6">{!! $condition_subscription->description1_en !!}</textarea>
{{--                                                        <div id="description1_en">{!! $condition_subscription->description1_en !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description2_ar" cols="38" rows="6">{!! $condition_subscription->description2_ar !!}</textarea>
{{--                                                        <div id="description2_ar">{!! $condition_subscription->description2_ar !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description2_en" cols="38" rows="6">{!! $condition_subscription->description2_en !!}</textarea>
{{--                                                        <div id="description2_en">{!! $condition_subscription->description2_en !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description3_ar" cols="38" rows="6">{!! $condition_subscription->description3_ar !!}</textarea>
{{--                                                        <div id="description3_ar">{!! $condition_subscription->description3_ar !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description3_en" cols="38" rows="6">{!! $condition_subscription->description3_en !!}</textarea>
{{--                                                        <div id="description3_en">{!! $condition_subscription->description3_en !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div id="description4_ar">{!! $condition_subscription->description4_ar !!}</div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div id="description4_en">{!! $condition_subscription->description4_en !!}</div>

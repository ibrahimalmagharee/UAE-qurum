            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    @if(get_admin_locale() == 'ar')
                        <span class="kt-subheader__desc">{{$social_link->name_ar}}</span>
                    @elseif(get_admin_locale() == 'en')
                        <span class="kt-subheader__desc">{{$social_link->name_en}}</span>
                    @endif
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            @endif
                            <form id="form-create-static_page" action="{{route_url('admin.social_link.update')}}" method="post" class="kt-form" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-xl-2 col-lg-2 col-form-label d-none">@lang('admin.labels.social_name_ar') </label>
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="hidden" name="name_ar" id="name_ar" value="{{$social_link->name_ar}}" class="form-control">
                                                ...
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-xl-2 col-lg-2 col-form-label d-none">@lang('admin.labels.social_name_en') </label>
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="hidden" name="name_en" id="name_en" value="{{$social_link->name_en}}" class="form-control">
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                        @error('name_en')
                                                        <span class="form-text text-muted"></span>
                                                        @enderror

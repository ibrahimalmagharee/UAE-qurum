            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    @if(get_admin_locale() == 'ar')
                        <span class="kt-subheader__desc">{{$goal->title_ar}}</span>
                    @elseif(get_admin_locale() == 'en')
                        <span class="kt-subheader__desc">{{$goal->title_en}}</span>
                    @endif
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            @endif
                            <form id="form-create-static_page" action="{{route_url('admin.program_goal.update')}}" method="post" class="kt-form" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="text" name="title_ar" id="title_ar" class="form-control" value="{{$goal->title_ar}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="text" name="title_en" id="title_en" class="form-control" value="{{$goal->title_en}}">
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                        <span class="form-text text-muted"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description1_ar" cols="38" rows="10">{!! $goal->description1_ar !!}</textarea>
{{--                                                        <div id="description1_ar">{!! $goal->description1_ar !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description1_en" cols="38" rows="10">{!! $goal->description1_en !!}</textarea>
{{--                                                        <div id="description1_en">{!! $goal->description1_en !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description2_ar" cols="38" rows="10">{!! $goal->description2_ar !!}</textarea>
{{--                                                        <div id="description2_ar">{!! $goal->description2_ar !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description2_en" cols="38" rows="10">{!! $goal->description2_en !!}</textarea>
{{--                                                        <div id="description2_en">{!! $goal->description2_en !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description3_ar" cols="38" rows="10">{!! $goal->description3_ar !!}</textarea>
{{--                                                        <div id="description3_ar">{!! $goal->description3_ar !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description3_en" cols="38" rows="10">{!! $goal->description3_en !!}</textarea>
{{--                                                        <div id="description3_en">{!! $goal->description3_en !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description4_ar" cols="38" rows="10">{!! $goal->description4_ar !!}</textarea>
{{--                                                        <div id="description4_ar">{!! $goal->description4_ar !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description4_en" cols="38" rows="10">{!! $goal->description4_en !!}</textarea>
{{--                                                        <div id="description4_en">{!! $goal->description4_en !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description5_ar" cols="38" rows="10">{!! $goal->description5_ar !!}</textarea>
{{--                                                        <div id="description5_ar">{!! $goal->description5_ar !!}</div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <textarea name="description5_en" cols="38" rows="10">{!! $goal->description5_en !!}</textarea>
{{--                                                        <div id="description5_en">{!! $goal->description5_en !!}</div>--}}

                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            @endif
                            <form id="form-create-static_page" action="{{route_url('admin.media_center.update')}}" method="post" class="kt-form" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" id="id" name="id" value="{{$media_center->id}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                                                            <div class="kt-avatar__holder" id="icon_u_" style="background-image: url('{{$media_center->image1}}')"></div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_2">
                                                            <div class="kt-avatar__holder" id="icon_u_" style="background-image: url('{{$media_center->image2}}')"></div>
                                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="@lang('admin.labels.change_icon')">
                                                                <i class="la la-pencil-square"></i>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_3">
                                                            <div class="kt-avatar__holder" id="icon_u_" style="background-image: url('{{$media_center->image3}}')"></div>
                                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="@lang('admin.labels.change_icon')">
                                                                <i class="la la-pencil-square"></i>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_4">
                                                            <div class="kt-avatar__holder" id="icon_u_" style="background-image: url('{{$media_center->image4}}')"></div>
                                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="@lang('admin.labels.change_icon')">
                                                                <i class="la la-pencil-square"></i>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_5">
                                                            <div class="kt-avatar__holder" id="icon_u_" style="background-image: url('{{$media_center->image5}}')"></div>
                                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="@lang('admin.labels.change_icon')">
                                                                <i class="la la-pencil-square"></i>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_6">
                                                            <div class="kt-avatar__holder" id="icon_u_" style="background-image: url('{{$media_center->image_video_cover}}')"></div>
                                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="@lang('admin.labels.change_icon')">
                                                                <i class="la la-pencil-square"></i>
                                                ...
                                                <div class="form-group row" id="video-uploader">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <video width="250" height="150" controls>
                                                            <source src="{{$media_center->getVideo($media_center->video)}}" type="video/mp4">
                                                        </video>

                                                    </div>
                                                    <input type="hidden" name="video" id="video" value="{{$media_center->video}}">
                                                </div>

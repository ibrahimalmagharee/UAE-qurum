            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    @if(get_admin_locale() == 'ar')
                        <span class="kt-subheader__desc">{{$main->title_ar}}</span>
                    @elseif(get_admin_locale() == 'en')
                        <span class="kt-subheader__desc">{{$main->title_en}}</span>
                    @endif
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            @endif
                            <form id="form-create-static_page" action="{{route_url('admin.main.update')}}" method="post" class="kt-form" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="text" name="title_ar" id="title_ar" class="form-control" value="{{$main->title_ar}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="text" name="title_en" id="title_en" class="form-control" value="{{$main->title_en}}">
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                        <span class="form-text text-muted"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div id="description_ar">{!! $main->description_ar !!}</div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div id="description_en">{!! $main->description_en !!}</div>

...
@section('content')
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container kt-container--fluid">
                ...
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper @if(\App\Models\VisionAndMission::count() > 1) d-none @endif">
                        <a href="{{route_url('admin.vision_and_mission.create')}}" class="btn btn-success">
                            <i class="fa fa-plus-circle"></i> @lang('admin.labels.add_new_vision_and_mission')
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="kt-container kt-container--fluid kt-grid__item kt-grid__item--fluid">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-datatable" id="vision_and_mission_datatable"></div>
    ...
    <div class="modal fade" id="delete-vision_and_mission-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
@section('page_scripts')
    ...
    <script src="{{app_asset('backend/js/datatables/vision_and_mission/datatable.js?v=').uniqid()}}"></script>
    <script>
        $('.bootstrap-select').selectpicker();

        $(document).on('click','.btn-delete-vision_and_mission',function (e) {
            e.preventDefault();
            $('#delete-vision_and_mission-modal').modal('show');
            var deleteUrl = $(this).attr('href');
            var pid = $(this).attr('data-id');
            $('#delete-vision_and_mission-modal #btn-confirm-delete').attr('data-url',deleteUrl).attr('data-id',pid);
        });
        ...
        $('#btn-confirm-delete').click(function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if(response.status) {
                        $('#delete-vision_and_mission-modal').modal('hide');
                        $('body #btn-delete-vision_and_mission-'+pid).closest('tr').css('background', '#f34343').delay(1000).hide(1000);
                    }
                }
            });

        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <span class="kt-subheader__desc">@lang('admin.labels.add_new_vision_and_mission')</span>
                </div>
            </div>
        </div>
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            @endif
                            <form id="form-create-static_page" action="{{route_url('admin.vision_and_mission.store')}}" method="post" class="kt-form" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="media_type" class="col-xl-2 col-lg-2 col-form-label">@lang('admin.labels.type')</label>
                                                    <div class="col-lg-6 col-xl-6">
                                                        <select name="type" id="type" class="form-control">
                                                            <option value="">@lang('admin.labels.choose_type')</option>
                                                            <option value="1">@lang('admin.labels.vision')</option>
                                                            <option value="2">@lang('admin.labels.mission')</option>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div id="description_ar">{!! old('description_ar') !!}</div>

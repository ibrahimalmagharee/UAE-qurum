        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <span class="kt-subheader__desc">@lang('admin.labels.add_new_contact_us_page')</span>
                </div>
            </div>
        </div>
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            @endif
                            <form id="form-create-static_page" action="{{route_url('admin.contact_us_page.store')}}" method="post" class="kt-form" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="text" name="location_ar" id="location_ar" value="{{old('location_ar')}}" class="form-control">
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                        @error('location_ar')
                                                        <span class="form-text text-muted"></span>
                                                        @enderror
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input type="text" name="location_en" id="location_en" value="{{old('location_en')}}" class="form-control">
                                                        <span class="invalid-feedback" role="alert"><strong></strong></span>
                                                        @error('location_en')
                                                        <span class="form-text text-muted"></span>
                                                        @enderror

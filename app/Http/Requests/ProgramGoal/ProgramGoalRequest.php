...
namespace App\Http\Requests\ProgramGoal;

use Illuminate\Foundation\Http\FormRequest;

class ProgramGoalRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'description5_ar.required' => __('validation.description_ar_required'),
            'description5_ar.max' => __('validation.description_ar_required'),
            'description5_en.required' => __('validation.description_en_required'),
            'description5_en.max' => __('validation.description_en_required'),
        ];
    }
}
